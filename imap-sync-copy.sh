...
do
    ...
    docker run --rm --name $2 -v $PWD:/var/tmp/ imapsync:local imapsync --nofoldersizesatend --addheader --host1 $SRCHOST --tls1 --port1 143 --authmech1 PLAIN --user1 $SRCUSER --passfile1 imap-secret-src \
